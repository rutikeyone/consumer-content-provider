...
import com.consumer.content.humans.presentation.details.viewmodel.HumanDetailsUiEvent
...
fun HumanDetailsView(
    ...
    onEvent: (HumanDetailsUiEvent) -> Unit,
) {
    Scaffold(
        topBar = {
            TopAppBar(
        ...
        PullToRefreshBox(
            ...
            when(val state = uiState.value) {
                ...
                is HumanDetailsUiState.Error -> AppErrorView(
                    onTryAgain = { onEvent(HumanDetailsUiEvent.Restart) }
                )
